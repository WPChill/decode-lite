...
<?php if ( has_post_format( 'quote' ) ) : ?>
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="reply"><a href="https://twitter.com/intent/tweet?screen_name=ScottSmith95&text=(about%3A%20<?php the_permalink(); ?>) " class="twitterreply replylink left" target="_blank" data-related="ScottSmith95">With Twitter</a><div class="replytrigger">Reply</div><a href="https://alpha.app.net/intent/post?text=@ScottSmith (about%3A%20<?php the_permalink(); ?>) " class="adnreply replylink right" target="_blank">With ADN</a></div></div>
